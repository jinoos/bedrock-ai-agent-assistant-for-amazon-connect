...
def get_bedrock_region():
    return ps_get('/abp/bedrock_region')


def get_bedrock_kb_id():
    return ps_get('/abp/bedrock_kb_id')


def get_bedrock_kb_result_count():
    return ps_get_int('/abp/bedrock_kb_result_count')


def get_bedrock_model_id():
    return "anthropic.claude-3-5-sonnet-20240620-v1:0"
    return ps_get('/abp/bedrock_model_id')


def get_semantic_cache_embedding_model_id():
    return ps_get('/abp/semantic_cache_embedding_model_id')


def get_region_cache_endpoint():
    return ps_get('/abp/region_cache_endpoint')
...
def get_temperature():
    return ps_get_float('/abp/temperature')


def get_top_k():
    return ps_get_int('/abp/top_k')


def get_top_p():
    return ps_get_int('/abp/top_p')


def get_max_tokens():
    return ps_get_int('/abp/max_tokens')


def get_region_cache_key():
    return ps_get('/abp/region_cache_key')
...
def get_semantic_cache_enabled():
    return ps_get_bool('/abp/semantic_cache_enabled')


def get_semantic_cache_score():
    return ps_get_float('/abp/semantic_cache_score')


def get_semantic_cache_endpoint():
    return ps_get('/abp/semantic_cache_endpoint')


def get_region_cache_enabled():
    return ps_get_bool('/abp/region_cache_enabled')
